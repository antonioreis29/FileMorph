"""
Canal de mão dupla entre uma tarefa e a fila (FASE 5, itens 16 e 17).

Até a Fase 4, uma conversão era uma caixa-preta: começava, terminava, e
no meio disso a interface não sabia de nada nem tinha como pedir para
parar. O progresso avançava de arquivo em arquivo, e cancelar só
impedia que as tarefas *seguintes* começassem.
...
class OperationCancelled(Exception):
    ...
    sem mostrar mensagem de falha para o usuário (item 17).
    """
